          ...
          child: Column(
            children: [
              ...
              SizedBox(
                ...
                Text(showtext?
                  "Showing the data recieved in past 24 hours":"showing all Community Fridges in the given radius",
                    ...
                    builder: (context, snapshot) {
                      ...
                      if (snapshot.hasData) {
                        ...
                        for (var message in messages) {
                          ...
                          if (showConstraint == "spotFridge") {
                            if (tempdist <= filterConstraint) {
                              messagewidgets.add(messagewidget);
                            }
                          } else if (tempdist <= filterConstraint &&
                              timeconstraint == false) {
                            messagewidgets.add(messagewidget);
                          }
                        }
